...
<div class="form-group form-group-lg">
    ...
    <div class="col-md-8">
        <input type="text" name="judul_gambar" class="form-control" placeholder="Tulis judul gambar..." value="<?php echo set_value('judul_gambar') ?>" required>
    </div>
</div>
<div class="form-group form-group-lg">
        ...
        <tbody>
            ...
            foreach ($gambar as $gambar) { ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url('admin/produk/delete_gambar/' . $produk->id_produk . '/' . $gambar->id_gambar) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakinkah ente ingin menghapus gambar ini?')">
