    ...
    <div class="cetak">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>Bukti Bayar</td>
                    <td> <?php if ($header_transaksi->status_bayar == "") {
                                echo 'Belum ada';
                            } else {
                                ?>
                ...
                <tr>
                    <td>Tanggal Bayar</td>
                    <td> <?php echo date('d-m-Y', strtotime($header_transaksi->jumlah_transaksi)) ?></td>
                </tr>
                <tr>
                    <td>Jumlah Bayar</td>
                    <td> IDR <?php echo number_format($header_transaksi->jumlah_bayar, '0', ',', '.') ?></td>
                </tr>
                <tr>
                    <td>Pembayaran Dari</td>
                    <td> <?php echo $header_transaksi->nama_bank ?> No. Rekening <?php echo $header_transaksi->rek_pembayaran ?> a.n <?php echo $header_transaksi->rek_pelanggan ?></td>
                </tr>
                <tr>
